var user = {
  ...
  updates: [newUpdate(moment('5:00PM 11/22/16', 'h:mmA M/D/YY'), 'I\'m going home for the day!'),
            newUpdate(moment('4:30PM 11/22/16', 'h:mmA M/D/YY'), 'Class just ended.'),
            newUpdate(moment('12:15PM 11/22/16', 'h:mmA M/D/YY'), '...and lunch is over, so back to class.'),
            newUpdate(moment('11:30AM 11/22/16', 'h:mmA M/D/YY'), 'Off to my lunch break! Maybe I\'ll go acrross the street?'),
            newUpdate(moment('9:00AM 11/22/16', 'h:mmA M/D/YY'), 'Starting my weekday by going to coding class!')]
}
